...
class ApiClient
{
     ...
     */
    public function __construct(\Alfresco\Core\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \Alfresco\Core\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\Alfresco\Core\ObjectSerializer::sanitizeForSerialization($postData));
        }
