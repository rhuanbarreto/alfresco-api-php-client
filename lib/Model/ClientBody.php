 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ClientBody implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClientBody';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['client'] === null) {
            $invalid_properties[] = "'client' can't be null";
        }
