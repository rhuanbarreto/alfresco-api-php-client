...
/**
 * RequestFacetQueriesInner Class Doc Comment
 *
 * @category    Class
 * @package     Alfresco
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RequestFacetQueriesInner implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RequestFacetQueries_inner';
    ...
    /**
     * Sets query
     * @param string $query A facet query
     * @return $this
     */
    ...
    /**
     * Sets label
     * @param string $label A label to include in place of the facet query
     * @return $this
     */
