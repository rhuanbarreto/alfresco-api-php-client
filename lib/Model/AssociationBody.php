...
/**
 * AssociationBody Class Doc Comment
 *
 * @category    Class
 * @package     Alfresco
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class AssociationBody implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AssociationBody';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['target_id'] === null) {
            $invalid_properties[] = "'target_id' can't be null";
        }
