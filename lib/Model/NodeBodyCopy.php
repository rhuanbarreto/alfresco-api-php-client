...
/**
 * NodeBodyCopy Class Doc Comment
 *
 * @category    Class
 * @package     Alfresco
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class NodeBodyCopy implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NodeBodyCopy';
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (!preg_match("/^(?!(.*[\\\"\\*\\\\\\>\\<\\?\/\\:\\|]+.*)|(.*[\\.]?.*[\\.]+$)|(.*[ ]+$))/", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling NodeBodyCopy., must conform to the pattern /^(?!(.*[\\\"\\*\\\\\\>\\<\\?\/\\:\\|]+.*)|(.*[\\.]?.*[\\.]+$)|(.*[ ]+$))/.");
        }
