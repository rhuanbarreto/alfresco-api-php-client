...
/**
 * SearchEntryHighlight Class Doc Comment
 *
 * @category    Class
 * @package     Alfresco
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SearchEntryHighlight implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SearchEntry_highlight';
    ...
    /**
     * Sets field
     * @param string $field The field where a match occured (one of the fields defined on the request)
     * @return $this
     */
    ...
    /**
     * Sets snippets
     * @param string[] $snippets Any number of snippets for the specified field highlighting the matching text
     * @return $this
     */
